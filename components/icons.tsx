...
export const UserGroupIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.513-.183 1.05-.317 1.62-.39 1.465-.24 2.978.256 4.105.886m-5.725-1.086a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM12 12.75a3.75 3.75 0 110-7.5 3.75 3.75 0 010 7.5z" />
  </svg>
);
...
export const BoldIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M8 11h4.5a2.5 2.5 0 1 0 0-5H8v5zm10 4.5a4.5 4.5 0 0 1-4.5 4.5H6V4h6.5a4.5 4.5 0 0 1 0 9H8v1.5h6.5a2.5 2.5 0 0 0 0-5H10V6h4.5a2.5 2.5 0 0 1 0 5H8v6h5.5a4.5 4.5 0 0 1 4.5-4.5z"/>
  </svg>
);

export const ItalicIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M10 5h2v2h-2V5zm-2 2h2v2H8V7zm4 0h2v2h-2V7zm2 2h2v2h-2V9zm-2 2h2v2h-2v-2zm-4 0h2v2H8v-2zm-2 2h2v2H6v-2zm10-2h2v2h-2v-2zm-2 2h2v2h-2v-2zm-6 2h2v2h-2v-2zm-2 2h2v2H8v-2zM10 21v-2h4v2h-4z"/>
    <path d="M14 3h-4v2h4V3z"/>
  </svg>
);
...
export const ListBulletIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M4 6a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm0 6a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm0 6a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm4-10h14v2H8V8zm0 6h14v2H8v-2zm0 6h14v2H8v-2z"/>
  </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        ...
        <path fill="#4CAF50" d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.211 35.091 26.715 36 24 36c-5.222 0-9.582-3.344-11.113-7.914l-6.573 5.129C9.21 39.754 16.12 44 24 44z" />
...
export const GoogleMeetIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M13.33 21.33h-2.66v-2.66h2.66v2.66zm-2.66-5.33h2.66V8c0-1.47-1.2-2.67-2.67-2.67H2.67v8h8z" fill="#fbc02d"/>
        <path d="M13.33 8h-2.66v8h2.66V8z" fill="#ea4335"/>
        <path d="M8 18.67h2.67V8H8v10.67z" fill="#4285f4"/>
        <path d="M18.67 13.33V8c0-1.47-1.2-2.67-2.67-2.67h-2.67v8h5.34z" fill="#34a853"/>
        <path d="M18.67 13.33h-2.67v2.67l2.67-2.67z" fill="#1e8e3e"/>
        <path d="M2.67 13.33h2.67v2.67L2.67 13.33z" fill="#f57c00"/>
        <path d="M8 5.33V2.67H5.33c1.47 0 2.67 1.2 2.67 2.66z" fill="#4285f4"/>
        <path d="M18.67 16l2.66 2.67V16h-2.66z" fill="#1e8e3e"/>
    </svg>
);
...
export const YouTubeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
         <path fill="#FF0000" d="M21.582,6.186c-0.23-0.814-0.908-1.491-1.722-1.722C18.25,4,12,4,12,4S5.75,4,4.14,4.464 c-0.814,0.23-1.491,0.908-1.722,1.722C2,7.796,2,12,2,12s0,4.204,0.418,5.814c0.23,0.814,0.908,1.491,1.722,1.722 C5.75,20,12,20,12,20s6.25,0,7.86-0.464c0.814-0.23,1.491-0.908,1.722-1.722C22,16.204,22,12,22,12S22,7.796,21.582,6.186z"></path>
