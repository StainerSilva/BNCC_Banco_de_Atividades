...
const DISCOVERY_DOC = 'https://www.googleapis.com/discovery/v1/apis/meet/v1/discovery.json';
...
export const initGapiClient = async (): Promise<void> => {
    await new Promise<void>((resolve, reject) => {
        gapi.load('client', () => {
             gapi.client.init({
                // The API Key is not required for discovery of OAuth-only APIs like Meet.
                // Providing it can sometimes cause this specific initialization error.
